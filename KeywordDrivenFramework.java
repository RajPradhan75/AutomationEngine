...
public class KeywordDrivenFramework 
{
	...
	public void checkFolderStructure() {
		...
		//sCurrentDir = System.getProperty("user.dir");
		//checkFileExists(sCurrentDir + "/Results");
		//checkFileExists(sCurrentDir + "/Results/Resources");
		...
		checkFileExists(classLoader.getResource("/AutoIt").toString());  //Mantis 0001131

		// Mantis 0000797
		if(sBrowser.equalsIgnoreCase("chrome"))
		{
			checkFileExists(sCurrentDir + "/SeleniumDrivers/chromedriver.exe");
		}
		else if(sBrowser.equalsIgnoreCase("IE"))
		{
			checkFileExists(sCurrentDir + "/SeleniumDrivers/IEDriverServer.exe");
		}
	}
